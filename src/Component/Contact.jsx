...
<motion.a
  ...
  className="mt-2 w-full inline-block text-lg font-[lato] font-medium px-9 py-3 rounded-xl shadow-lg bg-[#5245c9] text-white transition-all duration-300 hover:bg-orange-600 hover:scale-105 hover:shadow-xl text-center"
